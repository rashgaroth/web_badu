                            ...
                            <div class="col-sm-4">
                                <div class="footer-widget widget-one">
                                    ...
                                    <div class="widget-about-content">
                                        <p>
                                            BADu adalah aplikasi pelayanan para pencinta olahraga untuk dapat membooking lapangan tanpa harus datang pada lapangan tersebut
                                            BADu datang dalam kesulitan saat para pencinta olahraga kesulitan dalam membooking lapangan secara manual
                                            <br>
                                            <br>
                                            <b>Visi BADu</b>
                                            <br>
                                            menghubungkan mitra dengan pengguna, serta komunitas pengguna melalui aplikasi/web BADu sehingga dapat mempermudah proses transaksi dan interaksi.
                                            <br>
                                            <br>
                                            <b>Misi BADu</b>
                                            <br>
                                            BADu dapat mengubah sistem pembayaran lapangan olahraga di indonesia yang semula konvensional menjadi digital, dan BADu dapat menjadi wadah interaksi antar pengguna khususnya bagi komunitas olahraga di Indonesia.
                                        </p>
                                    </div>
                                </div>
                            </div>
